...
This document is used to track the TODOs for the project.

# Branches

## feature/storybook

- [ ] Fix CI workflow builds on visual-and-composition test... Then I can move on to cypress integration. See this failure https://github.com/thomas-hervey/microfrontends/actions/runs/6762978547/job/18379570104
...
- [ ] Double check that test-runner is actually working https://storybook.js.org/docs/react/writing-tests/test-runner
- [ ] Create stories for a test component to make sure I know it's working! If I want I can continue on fixing the popover.stories.ts file. It may need a "interaction"-style storybook to get the popover to open and close.
