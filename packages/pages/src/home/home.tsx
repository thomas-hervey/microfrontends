...
import { Button, Quote } from '@repo/design-system'
import { matchingTextColor, randomColor } from '@repo/utils'
...
export default function Home(): React.ReactNode {
  ...
  return (
    <Page>
      ...
      <Text className="mb-4">
        Works in the same way as <Code>packages/design-system</Code> but
      ...
      <Text className="mb-4">
        ...
        <Code>packages/design-system</Code> and opens them in{' '}
